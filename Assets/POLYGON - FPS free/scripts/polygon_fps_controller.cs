...
public class polygon_fps_controller : MonoBehaviour
{
    ...
    {
        get { return GetComponentInChildren<PowerHealth>().player_health; }
    }
    //
    ...
    {
        get { return GetComponentInChildren<PowerSpeed>().walk_speed; }
        set { walk_speed = _walk_speed; }
    }
    //
    ...
    public void walk_execute()
    {
        ...
        // Edit Script
        moveDirection = new Vector3(Vector3.forward.x * Time.deltaTime * forward_back * (walk_speed + _walk_speed), 0, Vector3.right.z * Time.deltaTime * forward_back * walk_speed);

        Vector3 FB = transform.TransformDirection(Vector3.forward * forward_back * (walk_speed + _walk_speed) * Time.deltaTime);
        Vector3 RL = transform.TransformDirection(Vector3.right * right_left * (walk_speed + _walk_speed) * Time.deltaTime);
        //
